...
*(Notice how the prompt immediately changes from `Router(config)#` to `R1(config)#`)*
...
*(You should see a message pop up stating that the interface changed state to "up".)*
...
## Reflection Questions (Submit to your instructor)
